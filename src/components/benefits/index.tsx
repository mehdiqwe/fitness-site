...
import { benefits } from "@/constants/cardInfo"
...
const Benefits = ({setSelectedPage}: Props) => {
  return (
    <section id="benefits" className="mx-auto min-h-full w-5/6 py-28">
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Benefits)}>
        ...
        <motion.div 
          ...
          variants={container}
        >
          {benefits.map((benefit) => <Benefit key={benefit.title} benefit={benefit} setSelectedPage={setSelectedPage}/>)}
        </motion.div>
