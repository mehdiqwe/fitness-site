...
const Home = ({setSelectedPage}: Props) => {
  ...
  return (
    ...
    >
        ...
        <motion.div 
            className="md:flex md:h-5/6 mx-auto w-5/6 justify-center items-center"
        ...
        >
            ...
            <div className="z-10 mt-40">
                ...
                >
                    ...
                    <AnchorLink
                        className="text-sm text-bold text-primary-500 underline hover:text-secondary-500"
            ...
            {/*images */}
            <div className="flex justify-center md:z-10 md:ml-40 md:mt-16 md:justify-items-end">
